...
## User Stories
#### [base]
1. Как казуальный игрок, я хочу быстро начинать игру и быстро выходить из нее (в один-два клика).
2. Как опытный игрок, я хочу играть со знакомыми игроками.
3. Как игрок, я хочу пользоваться интерактивным консольным приложением, которое поддерживает управление с клавиатуры.
4. Как игрок, я хочу, чтобы перед началом новой игры можно было сменить размеры поля.
